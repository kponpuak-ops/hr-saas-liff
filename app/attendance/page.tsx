...
import ExportButton from '../components/ExportButton' // นำเข้าคอมโพเนนต์ปุ่ม

export const dynamic = 'force-dynamic'

export default async function AttendancePage() {
  // ดึงข้อมูลการลงเวลา และเชื่อมตาราง (Join) กับข้อมูล users เพื่อเอาชื่อและตำแหน่งมาแสดง
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        {/* เพิ่มบรรทัดนี้ลงไป เพื่อแสดงปุ่ม Export */}
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                {records.map((record) => {
                  ...
                  // 1. เพิ่มฟังก์ชันเช็กมาสาย (เกิน 09:00 น.)
                  const isLate = (timeString: string | null) => {
                    ...
                    // ถ้าชั่วโมงเกิน 9 (เช่น 10) หรือชั่วโมงเท่ากับ 9 แต่มีเศษนาที ถือว่าสาย
                  ...
                  return (
                    <tr key={record.id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50 transition-colors">
                      ...
                      {/* 2. แก้ช่องเวลาเข้างาน เพื่อแสดงป้าย Tag สีแดง */}
                      <td className="py-4">
